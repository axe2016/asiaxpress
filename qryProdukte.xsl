	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>qryProdukte</title>
				<style type="text/css"></style>
			</head>
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="TEXT-ALIGN: right; WIDTH: 1.005cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.375cm"/>
						<col style="WIDTH: 11.666cm"/>
						<col style="WIDTH: 4.814cm"/>
						<col style="WIDTH: 3.465cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.931cm"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>LieferPreis</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>LokalPreis</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>picFileName</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="qryProdukte">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('LieferPreis', '#,##0.00 €;-#,##0.00 €', 'auto', '1031', 6)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('LokalPreis', '#,##0.00 €;-#,##0.00 €', 'auto', '1031', 6)"/>
								</td>
								<td>
									<xsl:value-of select="picFileName"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
